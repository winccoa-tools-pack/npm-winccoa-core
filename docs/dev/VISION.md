...
Create a **comprehensive, platform-agnostic, reusable TypeScript/Node.js library** that provides core WinCC OA functionality for building automation tools, IDE extensions, and utilities across multiple platforms.
...
├─────────────────────────────────────┤
│   @winccoa-tools-pack/core-utils    │  ← This library (core functionality)
├─────────────────────────────────────┤
